                ...
                return input
                    ...
                    .onCompletion { exception: Throwable? ->
                        ...
                        logger.info(buildString {
                            ...
                            appendLine("- Heap Memory: ${formatBytes(initialHeapMemory)} -> ${formatBytes(finalHeapMemory)} (+${formatBytes(heapMemoryIncrease)})")
                            appendLine("- Non-Heap Memory: ${formatBytes(initialNonHeapMemory)} -> ${formatBytes(finalNonHeapMemory)} (+${formatBytes(nonHeapMemoryIncrease)})")
